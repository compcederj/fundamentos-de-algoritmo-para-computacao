# Fundamentos de Algorítmos para Computação
Repositório de provas antigas da Disciplina **Fundamentos de Algorítmos para Computação** do curso de **Tecnologia em Sistemas de Computaćao** da **UFF** ministrado através do **CEDERJ**.
...
`git clone https://github.com/compcederj/fundamentos-de-algoritmo-para-computacao.git`
...
`git clone git@github.com:compcederj/fundamentos-de-algoritmo-para-computacao.git`
...
# Fundamentos de Algorítmos para Computação
Repositório de provas antingas da Disciplina **Fundamentos de Algorítmos para Computação** do curso de **Tecnologia em Sistemas de Computaçao** da **UFF** ministrado através do **CEDERJ**.
